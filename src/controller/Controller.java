...
public class Controller {
    ...
    public void startGame() {
        ...
        player.initializeGame(dealer, player1, bot1, bot2, hiddenCard, deck);
    ...
    public void stayAction() {
        ...
        player.bot1Turn();   // Bot1 gioca il suo turno
        player.bot2Turn();   // Bot2 gioca il suo turno
        System.out.println("Stay action performed"); // Stampa che è stato eseguito il comando "stay"
    }
    ...
    public List<String> getPlayerSums() {
        ...
        playerSums.add("Bot1: " + player.getBot1().getSum());
        playerSums.add("Bot2: " + player.getBot2().getSum());
    ...
    public String getWinnerMessage() {
        return "Risultato: " + player.determineWinner();
    }
